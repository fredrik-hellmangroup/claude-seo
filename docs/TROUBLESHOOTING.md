...
```bash
head -5 ~/.copilot/skills/seo/SKILL.md
```
...
```bash
ls ~/.copilot/agents/seo-*.md
```

2. Check agent frontmatter:
```bash
head -5 ~/.copilot/agents/seo-technical.md
```

3. Re-install agents:
```bash
cp /path/to/claude-seo/agents/*.md ~/.copilot/agents/
```
...
```bash
# Test fetch
python3 ~/.copilot/skills/seo/scripts/fetch_page.py https://example.com

# Test parse
python3 ~/.copilot/skills/seo/scripts/parse_html.py page.html --json

# Test screenshot
python3 ~/.copilot/skills/seo/scripts/capture_screenshot.py https://example.com
```
